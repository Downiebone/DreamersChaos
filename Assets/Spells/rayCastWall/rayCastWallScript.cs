...
public class rayCastWallScript : spell
{
    ...
    [SerializeField] private LayerMask objectsToHit;
    public override void Activate(GameObject parent, Transform firePoint)
    {
        RaycastHit hit;
        // Does the ray intersect any objects excluding the player layer
        if (Physics.Raycast(firePoint.position, firePoint.TransformDirection(Vector3.forward), out hit, Mathf.Infinity, objectsToHit))
        {
